...
# note (aaron): dense multi speaker meetings decode to about 4.5 output
...
class MossTranscribeDiarizeRequestData(SGLangARRequestData):
    ...
    # note (aaron): the scheduler clamps max_new_tokens to the remaining
...
def make_moss_transcribe_diarize_scheduler_adapters(
    ...
    def request_builder(payload: StagePayload) -> MossTranscribeDiarizeRequestData:
        ...
        # note (aaron): cap the processor at the model context rather than a
        ...
        # note (aaron): the model default was sized for short clips and
