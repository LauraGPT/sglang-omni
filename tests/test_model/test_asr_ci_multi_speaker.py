...
# note (aaron): clip 2 leads and gets truncated to hit 90 minutes, clips 0
...
# note (aaron): well above the observed 30k output tokens for this sample
...
# note (aaron): catastrophic bounds for the single 90 minute sample, not
...
def _assert_aishell4_long90_results(checks: MetricCheckCollector, results) -> None:
    ...
    # note (aaron): one 90 minute sample, so speaker attribution and speed
